...
public sealed class FinchScalpingIndicator : Qt.Indicator
{
    ...
    /// direction verdict last flipped side, reading "ONLY BULLISH ABOVE" or "ONLY BEARISH
    /// BELOW" (reworded 2026-09-17 from "...LONG/SHORT SCALPS..." — the operator's own call,
    /// since this line means the regime, not a scalp-specific entry) — the operator's own
    /// framing (2026-09-16) for what this line means to them, replacing its original "POSSIBLE
    /// LONG SCALP" entry-call wording. It still moves
            ...
            try
            {
                DirectionCalloutDraw? bias = this.directionCalloutSide != 0
                    ...
                    ? new DirectionCalloutDraw(
                        ...
                        this.directionCalloutSide > 0 ? "ONLY BULLISH ABOVE" : "ONLY BEARISH BELOW",
                        this.directionCalloutSide > 0)
                    : null;
